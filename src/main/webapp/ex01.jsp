...
<body>
	...
	<br>path : ${contextPath }
	<br> path11 : ${contextPath1 }
	<br>
	<a href="${contextPath1 }/ex01_1.jsp">경로이동</a>
	<a href="<%=request.getContextPath()%>/ex01_1.jsp">경로이동</a>
	<hr>
	<form action="${contextPath }/ex01_1.jsp">
		<input type="checkbox" name="check" value="사과">사과주스 <input
			type="checkbox" name="check" value="배">배주스 <input
			type="checkbox" name="check" value="키위">키위주스 <br> <input
